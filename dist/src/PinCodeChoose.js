    ...
    constructor(props) {
        ...
        this.endProcessCreation = (pinCode) => {
            if (this.props.validatePin && !this.props.validatePin(pinCode)) {
                this.setState({
                    pinCodeStatus: index_1.PinResultStatus.failure
                });
                setTimeout(() => this.setState({
                    pinCodeStatus: index_1.PinResultStatus.initial
                }), 1000);
                return;
            }
